...
/**
 * JUnit Rule for FragmentScenario.
 *
 * Usage:
 * <pre>
 * @Rule
 * public FragmentRule<DevicesListFragment, DashBoardActivity> fragmentScenarioRule =
 *   new FragmentRule(DevicesListFragment.class, DashBoardActivity.class);
 * private DevicesListFragment deviceListFragment;
 *
 * @Before
 * public void setUp() {
 *   deviceListFragment = fragmentScenarioRule.getFragment();
 * }
 * </pre>
 */
